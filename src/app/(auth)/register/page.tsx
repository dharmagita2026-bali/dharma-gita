...
export default function RegisterPage() {
  ...
  const [showPassword, setShowPassword] = useState(false); // State untuk toggle mata password utama
  const [showConfirmPassword, setShowConfirmPassword] = useState(false); // State untuk mata konfirmasi password
  ...
  return (
    <div className="w-full max-w-md bg-white border-4 border-[#D7CCC8] rounded-[45px] p-10 space-y-10 shadow-sm text-[#4E342E] font-sans">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-3xl font-black uppercase tracking-tighter italic text-[#4E342E]">Register</h1>
        <p className="text-xs text-[#8D6E63] font-medium leading-relaxed max-w-[320px] mx-auto">
